...
const messages = {
  ...
  'command.exportImage': 'Export as Image', 'command.pinFile': 'Pin / Unpin File',
  'command.auditImages': 'Audit Document Images', 'command.renameFile': 'Rename File',
  'command.deleteFile': 'Delete File', 'command.revealFile': 'Reveal File',
  'command.renameHeading': 'Rename Heading', 'command.promoteHeading': 'Promote Heading',
  'command.demoteHeading': 'Demote Heading', 'command.moveHeadingUp': 'Move Section Up',
  'command.moveHeadingDown': 'Move Section Down', 'command.chooseTheme': 'Choose Theme',
  'command.applyPreset': 'Apply Writing Preset',
...
const translations = {
  ja: {
    ...
    'command.exportImage':'画像としてエクスポート','command.pinFile':'ファイルをピン留め / 解除',
    'command.auditImages':'文書の画像を監査','command.renameFile':'ファイル名を変更','command.deleteFile':'ファイルを削除','command.revealFile':'ファイルを表示',
    'command.renameHeading':'見出し名を変更','command.promoteHeading':'見出しレベルを上げる','command.demoteHeading':'見出しレベルを下げる',
    'command.moveHeadingUp':'セクションを上へ移動','command.moveHeadingDown':'セクションを下へ移動','command.chooseTheme':'テーマを選択',
    'command.applyPreset':'執筆プリセットを適用',
