...
const en = {
  ...
  shortcuts: 'Shortcuts', shortcutsVscode: 'VS Code', shortcutsMarkda: 'Markda',
  preferMarkdaShortcuts: 'Give Markda shortcuts priority', preferVscodeShortcuts: 'Give VS Code shortcuts priority',
  shortcutsCurrent: 'Shortcut priority: {0}',
  ...
  syncSaved: 'Synced', syncSaving: 'Syncing…', syncPending: 'Changes waiting to sync', syncConflict: 'External change detected',
...
const catalogs: Record<Exclude<SupportedLocale, 'en'>, Messages> = {
  ja: {
    ...
    syncSaved:'同期済み',syncSaving:'同期中…',syncPending:'同期待ちの変更',syncConflict:'外部変更を検出',
